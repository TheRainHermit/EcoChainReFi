...
export default function MaterialDeposit({ wallet, onTransactionAdded }: MaterialDepositProps) {
  ...
  const handleDeposit = async (materialType: string) => {
    ...
    try {
      const ecoAmount = MATERIAL_RATES[materialType as keyof typeof MATERIAL_RATES];
      ...
      setEarnedAmount(ecoAmount);
      setShowSuccess(true);

      toast({
        title: '¡Depósito exitoso!',
        description: `Has ganado ${formatEcoAmount(ecoAmount)} $EC0`,
      });
      ...
      <Card className="border-2 border-green-500 shadow-2xl bg-gradient-to-br from-green-50 to-emerald-50">
        <CardContent className="flex flex-col items-center justify-center py-16">
          ...
          <p className="text-xl text-gray-700 mb-4">
            Has ganado <span className="font-bold text-green-600">{formatEcoAmount(earnedAmount)} $EC0</span>
          </p>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold">3.0 $EC0</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold">2.0 $EC0</p>
              </div>
              <div className="text-5xl opacity-80">🥤</div>
            </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold">15.6 $EC0</p>
              </div>
              <div className="text-5xl opacity-80">🌍</div>
            </div>
