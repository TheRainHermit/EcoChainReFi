    ...
    <div className="grid md:grid-cols-2 gap-8">
      <Card className="border-2 border-emerald-200 shadow-xl bg-white">
        <CardHeader>
          ...
          <CardDescription>
            Escanea este código para recibir $EC0 en el hardware de recolección
          </CardDescription>
        </CardHeader>
      ...
      <Card className="border-2 border-green-200 shadow-xl bg-white">
        <CardHeader>
          ...
          <CardDescription>
            Detalles de tu wallet en Base Network
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="bg-blue-50 px-4 py-3 rounded-lg border border-blue-200">
              <span className="text-blue-700 font-medium">Base Network</span>
            </div>
          </div>
          ...
          <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4 mt-6">
            <p className="text-sm text-emerald-800 leading-relaxed">
              <strong>💡 Consejo:</strong> Muestra este QR en cualquier punto de recolección EcoChain para recibir tus $EC0 instantáneamente tras depositar materiales reciclables.
            </p>
          </div>
        </CardContent>
      </Card>
