...
import { type EcoTransaction } from '@/lib/supabase';
...
export default function TransactionHistory({ transactions }: TransactionHistoryProps) {
  ...
  const totalEarned = transactions.reduce(
    (sum, tx) => sum + parseFloat(tx.eco_amount.toString()),
    0
  );
      ...
      <div className="grid md:grid-cols-3 gap-4">
        <Card className="bg-gradient-to-br from-emerald-500 to-green-600 text-white border-0">
          <CardContent className="p-6">
            ...
            <p className="text-3xl font-bold mb-1">{formatEcoAmount(totalEarned)} $EC0</p>
                ...
                >
                  ...
                  <div className="text-right">
                    <p className="text-2xl font-bold text-emerald-600">
                      +{formatEcoAmount(parseFloat(tx.eco_amount.toString()))}
                    </p>
